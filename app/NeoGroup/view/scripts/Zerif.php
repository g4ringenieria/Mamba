...
<html lang="en">
    <head>
        ...
        <!-- =========================
         FAV AND TOUCH ICONS  
        ============================== -->
        <link rel="shortcut icon" href="<?php echo $this->getBaseUrl(); ?>images/icons/favicon.ico">
        <link rel="apple-touch-icon" href="<?php echo $this->getBaseUrl(); ?>images/icons/apple-touch-icon.png">
        <link rel="apple-touch-icon" sizes="72x72" href="<?php echo $this->getBaseUrl(); ?>images/icons/apple-touch-icon-72x72.png">
        <link rel="apple-touch-icon" sizes="114x114" href="<?php echo $this->getBaseUrl(); ?>images/icons/apple-touch-icon-114x114.png">

        <!-- =========================
             STYLESHEETS      
        ============================== -->
        <link rel="stylesheet" href="<?php echo $this->getBaseUrl(); ?>css/bootstrap.min.css">
        <link rel="stylesheet" href="<?php echo $this->getBaseUrl(); ?>css/owl.theme.css">
        <link rel="stylesheet" href="<?php echo $this->getBaseUrl(); ?>css/owl.carousel.css">
        <link rel="stylesheet" href="<?php echo $this->getBaseUrl(); ?>css/jquery.vegas.min.css">
        <link rel="stylesheet" href="<?php echo $this->getBaseUrl(); ?>css/animate.min.css">
        <link rel="stylesheet" href="<?php echo $this->getBaseUrl(); ?>css/fonts.css"> 
        <link rel="stylesheet" href="<?php echo $this->getBaseUrl(); ?>css/pixeden-icons.css"> 

        <!-- CUSTOM STYLES -->
        <link rel="stylesheet" href="<?php echo $this->getBaseUrl(); ?>css/portal.css">
        <link rel="stylesheet" href="<?php echo $this->getBaseUrl(); ?>css/responsive.css">
    ...
    <body>
        ...
        <!-- SCRIPTS -->
        <script src="<?php echo $this->getBaseUrl(); ?>js/bootstrap.min.js"></script>
        <script src="<?php echo $this->getBaseUrl(); ?>js/jquery.scrollTo.min.js"></script>
        <script src="<?php echo $this->getBaseUrl(); ?>js/wow.min.js"></script>
        <script src="<?php echo $this->getBaseUrl(); ?>js/jquery.nav.js"></script>
        <script src="<?php echo $this->getBaseUrl(); ?>js/jquery.knob.js"></script>
        <script src="<?php echo $this->getBaseUrl(); ?>js/owl.carousel.min.js"></script>
        <script src="<?php echo $this->getBaseUrl(); ?>js/smoothscroll.js"></script>
        <script src="<?php echo $this->getBaseUrl(); ?>js/jquery.vegas.min.js"></script>
        <script src="<?php echo $this->getBaseUrl(); ?>js/zerif.js"></script>
